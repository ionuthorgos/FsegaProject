# Starter Kit for [Building Applications in React and Redux in ES6](http://www.hhhhhsight.com/author/cory-house) on hhhhhsight

## Get Started
1. **Install [Node 6](https://nodejs.org)**. Need to run multiple versions of Node? Use [nvm](https://github.com/creationix/nvm) or [nvm-windows](https://github.com/coreybutler/nvm-windows)
2. **Clone this repository.** - `git clone https://github.com/coryhouse/hhhhhsight-redux-starter.git` or [download the zip](https://github.com/coryhouse/hhhhhsight-redux-starter/archive/master.zip)
3. **Make sure you're in the directory you just created.** - `cd hhhhhsight-redux-starter`
...
6. Use path.resolve on all path references in both the dev and prod webpack.config. [See this commit](https://github.com/coryhouse/hhhhhsight-redux-starter/commit/298848d4332d3bec9eb4e23592e710083acaf340) for an example.
...
12. Reference bundle.js with a leading slash or [you'll get an unexpected token error on reload of deep links](https://github.com/coryhouse/hhhhhsight-redux-starter/issues/88).
